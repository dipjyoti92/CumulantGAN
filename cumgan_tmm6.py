...
toy_data = genfromtxt('./data/toy_example_tmm6.csv', delimiter=',', dtype='float32')
#toy_data = genfromtxt('toy_example_tmm6_nonuniform.csv', delimiter=',', dtype='float32')
...
csv_name = sess_name + '/csv_D_' + str(D_h1_dim) + '_' + str(D_h2_dim) + '_' + str(D_h3_dim) + '_G_' + str(G_h1_dim) + '_'+str(G_h2_dim) + '_' + str(G_h3_dim) + '_uniform/'
