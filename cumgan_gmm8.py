...
G_h1_dim=16             # generator hidden dimensions
G_h2_dim=16             # generator hidden dimensions
G_h3_dim=16             # generator hidden dimensions
...
#toy_data = genfromtxt('toy_example_gmm8.csv', delimiter=',', dtype='float32')
toy_data = genfromtxt('./data/toy_example_gmm8_nonuniform.csv', delimiter=',', dtype='float32')
...
csv_name = sess_name + '/csv_D_' + str(D_h1_dim) + '_' + str(D_h2_dim) + '_G_' + str(G_h1_dim) + '_' + str(G_h2_dim) + '_' + str(G_h3_dim) + '_nonuniform/'
...
for it in range(epochs):
    ...
    if it % SF == 0:
        ...
        fig = plot_withDec(samples,X_mb,dis_dec,6)
