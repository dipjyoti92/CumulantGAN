...
toy_data = genfromtxt('./data/toy_example_gmm8.csv', delimiter=',', dtype='float32')
#toy_data = genfromtxt('toy_example_gmm8_nonuniform.csv', delimiter=',', dtype='float32')
...
csv_name = sess_name + '/csv_D_' + str(D_h1_dim) + '_' + str(D_h2_dim) + '_G_' + str(G_h1_dim) + '_' + str(G_h2_dim) + '_uniform/'
